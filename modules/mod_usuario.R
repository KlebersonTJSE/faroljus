...
mod_usuario_ui <- function(id){
    ...
    # div simples (em vez de fluidPage): esta UI é exibida dentro de uma
    # aba do app.R, que já está dentro de um fluidPage — aninhar outro
    # fluidPage duplicava o container e o espaçamento lateral.
    div(
        class = "pt-3",
